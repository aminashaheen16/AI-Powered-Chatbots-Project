...
st.markdown("""
    ...
    * { font-family: 'Outfit', sans-serif; }
    ...
    .header-logo { font-size: 2rem; font-weight: 800; color: #ffffff; padding: 20px 0; margin-bottom: 20px; text-align: left; }
    .header-logo span { color: #c084fc; }
    
    .chat-bubble-user { background: #7e22ce; color: #ffffff; padding: 12px 22px; border-radius: 20px 20px 0 20px; margin-bottom: 20px; margin-left: auto; width: fit-content; max-width: 85%; box-shadow: 0 4px 15px rgba(0,0,0,0.3); }
    .chat-bubble-ai { background: #1e293b; color: #f1f5f9; border: 1px solid rgba(255,255,255,0.05); padding: 12px 22px; border-radius: 20px 20px 25px 0; margin-bottom: 20px; width: fit-content; max-width: 85%; line-height: 1.6; box-shadow: 0 4px 15px rgba(0,0,0,0.3); }
    ...
    .stButton > button { background-color: #7e22ce !important; color: white !important; border-radius: 10px !important; border: none !important; font-weight: 600 !important; }
